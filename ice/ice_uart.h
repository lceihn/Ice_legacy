...
#define ice_debug           0       //printf via uart, 0:disable 1:enable
#define ice_usb             0       //use usb virtual port communication
...
typedef struct
{
    ...
    uint8_t tx_buf[ice_dma_size];   //ice uart tx data buffer(maxlength:256)
